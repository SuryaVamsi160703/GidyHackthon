  ...
  return (
    <div className="container">
      <div className="wrapper">
        <div className="title">Intro to  JS</div>
        <div className="desc">
          Learn JS by clicking the link below:
          <br />
          {/* <a
        ...
        <ol>
          ...
          <li>Adopt JS as per the instructions on that page.</li>
        </ol>
          ...
          <ul>
            <li>
              <a
                ...
                rel="noopener noreferrer"
              >
                Visit GeeksforGeeks JS Tutorial
              </a>
            </li>
            <li>
              <a
