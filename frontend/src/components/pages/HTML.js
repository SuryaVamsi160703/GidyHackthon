...
import "./HtmlPage.css"; // Import the CSS file
  ...
  return (
    <div className="container">
      <div className="wrapper">
        <div className="title">Intro to HTML</div>
        <div className="desc">
          Learn HTML by clicking the link below:
          <br />
          {/* <a
          ...
          <button
            ...
            onClick={() =>
              openLink(
                "https://gidy.ai/template-details/Introduction%20to%20HTML"
              )
            } // Example button link
          >
            Open Gidy
        ...
        <ol>
          ...
          <li>Adopt HTML as per the instructions on that page.</li>
        </ol>
          ...
          <ul>
            <li>
              <a
                ...
                rel="noopener noreferrer"
              >
                Visit GeeksforGeeks HTML Tutorial
              </a>
            </li>
            <li>
              <a
