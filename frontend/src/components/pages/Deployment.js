  ...
  return (
    <div className="container">
      <div className="wrapper">
        <div className="title">Intro to  Deploy</div>
        <div className="desc">
          Learn Deployment by clicking the link below:
          <br />
          {/* <a
        ...
        <ol>
          ...
          <li>Adopt Deploy as per the instructions on that page.</li>
        </ol>
          ...
          <ul>
            <li>
              <a
                ...
                rel="noopener noreferrer"
              >
                Visit GeeksforGeeks Deploy Tutorial
              </a>
            </li>
            <li>
              <a
