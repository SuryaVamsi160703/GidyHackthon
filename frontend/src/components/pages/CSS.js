  ...
  return (
    <div className="container">
      <div className="wrapper">
        <div className="title">Intro to   CSS</div>
        <div className="desc">
          Learn CSS by clicking the link below:
          <br />
          {/* <a
          ...
          <button
            ...
            onClick={() =>
              openLink(
                "https://gidy.ai/template-details/Introduction%20to%20CSS"
              )
            } // Example button link
          >
            Open Gidy
        ...
        <ol>
          ...
          <li>Adopt CSS as per the instructions on that page.</li>
        </ol>
          ...
          <ul>
            <li>
              <a
                ...
                rel="noopener noreferrer"
              >
                Visit GeeksforGeeks CSS Tutorial
              </a>
            </li>
            <li>
              <a
